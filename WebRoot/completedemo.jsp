 <%@ page language="java" contentType="text/html; charset=UTF-8"
	import="com.yunrer.ueditor.ActionEnter"
    pageEncoding="UTF-8"%>
...
<head>
    ...
    <script type="text/javascript" charset="utf-8" src="/js/ueedit/lang/zh-cn/zh-cn.js"></script>
...
<div id="btns">
    <div>
        ...
        <button onclick="getdefindcontent()">获得内容</button>
