$(function () {
    ...
    $.fn.InitUploader = function (b) {
        var fun = function (parentObj) {
            ...
            //初始化属性
            p.sendurl += "?action=UpLoadFile&product_id="+$("#product_id").val()+"&product_items_id="+$("#product_items_id").val();
            ...
            uploader.on('uploadSuccess', function (file, data) {
                ...
                if (data.status == '1') {
                    ...
                    if (!p.multiple) {
                    	...
                    	$(".noimg").remove();
                    	$("#cleardiv").remove();
                    	 _html = "<div class=\"imgbox\" imgid=\""+data.id+"\"><img src=\""+data.path+"\" onerror=\"this.src='/images/no_pic.png'\"/></div><div id=\"cleardiv\" style=\"clear:both;\"></div>";
                    	
                    }else{
                    	$(".noimg").remove();
                    	$("#cleardiv").remove();
                    	for(var j=0;j<data.status;j++){
                    	 _html += "<div class=\"imgbox\" imgid=\""+data.id+"\"><img src=\""+data.path+"\" onerror=\"this.src='/images/no_pic.png'\"/></div><div id=\"cleardiv\" style=\"clear:both;\"></div>";
                    	
                    	}
                    	$(".imgboxs").append(_html);
