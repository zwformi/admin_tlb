...
<body>
    <div class="main markdown">
        ...
        <ul class="icon_lists clear">
                ...
                <li>
                <i class="icon iconfont icon-gongsizizhi"></i>
                    <div class="name">公司资质</div>
                    <div class="fontclass">.icon-gongsizizhi</div>
                </li>
                ...
                <li>
                <i class="icon iconfont icon-msnui-dashboard"></i>
                    <div class="name">仪表</div>
                    <div class="fontclass">.icon-msnui-dashboard</div>
                </li>
                ...
                <li>
                <i class="icon iconfont icon-crm"></i>
                    <div class="name">CRM</div>
                    <div class="fontclass">.icon-crm</div>
                </li>
                ...
                <li>
                <i class="icon iconfont icon-crmtubiao66"></i>
                    <div class="name">任务</div>
                    <div class="fontclass">.icon-crmtubiao66</div>
                </li>
                ...
                <li>
                <i class="icon iconfont icon-baoxianzhushouicon15"></i>
                    <div class="name">制作计划书</div>
                    <div class="fontclass">.icon-baoxianzhushouicon15</div>
                </li>
            
                <li>
                <i class="icon iconfont icon-daqiashijian"></i>
                    <div class="name">打卡时间</div>
                    <div class="fontclass">.icon-daqiashijian</div>
                </li>
            
                <li>
                <i class="icon iconfont icon-xuanzeyixuanze"></i>
                    <div class="name">选择-已选择</div>
                    <div class="fontclass">.icon-xuanzeyixuanze</div>
                </li>
                ...
                <li>
                <i class="icon iconfont icon-baifang"></i>
                    <div class="name">拜访</div>
                    <div class="fontclass">.icon-baifang</div>
                </li>
                ...
                <li>
                <i class="icon iconfont icon-shengdankefu"></i>
                    <div class="name">圣诞简化-客服</div>
                    <div class="fontclass">.icon-shengdankefu</div>
                </li>
                ...
                <li>
                <i class="icon iconfont icon-fanhuijine"></i>
                    <div class="name">返回金额</div>
                    <div class="fontclass">.icon-fanhuijine</div>
                </li>
            
                <li>
                <i class="icon iconfont icon-xiaban1"></i>
                    <div class="name">下班</div>
                    <div class="fontclass">.icon-xiaban1</div>
                </li>
                ...
                <li>
                <i class="icon iconfont icon-icon1460346853465"></i>
                    <div class="name">消息</div>
                    <div class="fontclass">.icon-icon1460346853465</div>
                </li>
                ...
                <li>
                <i class="icon iconfont icon-wodesuifang1"></i>
                    <div class="name">我的随访</div>
                    <div class="fontclass">.icon-wodesuifang1</div>
                </li>
                ...
                <li>
                <i class="icon iconfont icon-lianxiren2"></i>
                    <div class="name">通讯录1</div>
                    <div class="fontclass">.icon-lianxiren2</div>
                </li>
                ...
                <li>
                <i class="icon iconfont icon-3xiaoxi"></i>
                    <div class="name">消息</div>
                    <div class="fontclass">.icon-3xiaoxi</div>
                </li>
                ...
                <li>
                <i class="icon iconfont icon-shangwushangban"></i>
                    <div class="name">上午上班</div>
                    <div class="fontclass">.icon-shangwushangban</div>
                </li>
            
                <li>
                <i class="icon iconfont icon-icon-grid-bold"></i>
                    <div class="name">应用</div>
                    <div class="fontclass">.icon-icon-grid-bold</div>
                </li>
            
                <li>
                <i class="icon iconfont icon-sj-copy"></i>
                    <div class="name">商机</div>
                    <div class="fontclass">.icon-sj-copy</div>
                </li>
            
                <li>
                <i class="icon iconfont icon-richeng"></i>
                    <div class="name">日程</div>
                    <div class="fontclass">.icon-richeng</div>
                </li>
            
                <li>
                <i class="icon iconfont icon-tonggao"></i>
                    <div class="name">公告</div>
                    <div class="fontclass">.icon-tonggao</div>
                </li>
            
                <li>
                <i class="icon iconfont icon-lianxiren11"></i>
                    <div class="name">联系人</div>
                    <div class="fontclass">.icon-lianxiren11</div>
                </li>
            
                <li>
                <i class="icon iconfont icon-shangji"></i>
                    <div class="name">商机</div>
                    <div class="fontclass">.icon-shangji</div>
                </li>
                ...
                <li>
                <i class="icon iconfont icon-suoyouyonghu"></i>
                    <div class="name">所有用户</div>
                    <div class="fontclass">.icon-suoyouyonghu</div>
                </li>
            
                <li>
                <i class="icon iconfont icon-kehu1"></i>
                    <div class="name">客户1</div>
                    <div class="fontclass">.icon-kehu1</div>
                </li>
            
                <li>
                <i class="icon iconfont icon-lianxiren3"></i>
                    <div class="name">联系人1</div>
                    <div class="fontclass">.icon-lianxiren3</div>
                </li>
                ...
                <li>
                <i class="icon iconfont icon-baoxiao"></i>
                    <div class="name">报销1</div>
                    <div class="fontclass">.icon-baoxiao</div>
                </li>
            
                <li>
                <i class="icon iconfont icon-baifang1"></i>
                    <div class="name">拜访1</div>
                    <div class="fontclass">.icon-baifang1</div>
                </li>
            
                <li>
                <i class="icon iconfont icon-zhoubao"></i>
                    <div class="name">周报1</div>
                    <div class="fontclass">.icon-zhoubao</div>
                </li>
            
                <li>
                <i class="icon iconfont icon-qingjia"></i>
                    <div class="name">请假1</div>
                    <div class="fontclass">.icon-qingjia</div>
                </li>
            
                <li>
                <i class="icon iconfont icon-daibanrenwu"></i>
