...
import com.yunrer.util.zcy.openapi.auth.ShaHmac256;
import com.yunrer.util.zcy.openapi.auth.Signer;
import com.yunrer.util.zcy.openapi.http.HttpClient;
import com.yunrer.util.zcy.openapi.util.Md5Util;
import com.yunrer.util.zcy.openapi.util.SignUtil;
...
public class ZcyOpenClient {
    ...
    private static String doPost(ZcyOpenRequest zcyOpenRequest) throws Exception {
        ...
        /*HmacSHA256签名*/
        Signer signer = new ShaHmac256();
        System.out.println(zcyOpenRequest.getAppSecret());
        String signature = signer.sign(zcyOpenRequest.getAppSecret(), stringToSign, "utf-8");
