...
<body>
    ...
    <div class="formbody">
        <div class="formtitle" style="margin:0"><span>角色列表</span></div>
        <div class="rightinfo">
            <div class="tools">
                <ul class="toolbar">
                <%if(com.yunrer.common.AuthUtil.getAttribute(session, "b_system_role_add")){%>
                	<li id="add"><span><img src="<%=basePath%>images/t01.png" /></span>新增</li>
                <%}%>
                <%if(com.yunrer.common.AuthUtil.getAttribute(session, "b_system_role_edit")){%>
                    <li class="edit"><span><img src="<%=basePath%>images/t02.png" /></span>编辑</li>
                <%}%>
                <%if(com.yunrer.common.AuthUtil.getAttribute(session, "b_system_role_delete")){%>
                    <li class="delete"><span><img src="<%=basePath%>images/t03.png" /></span>删除</li>
                <%}%>
                <%if(com.yunrer.common.AuthUtil.getAttribute(session, "b_system_role_auth")){%>
                    <li class="auth"><span><img src="<%=basePath%>images/t07.png" /></span>权限配置</li>
                <%}%>
                <%if(com.yunrer.common.AuthUtil.getAttribute(session, "b_system_role_search")){%>
            ...
            $(".delete").click(function(){
            	if($("input[name='check']:checked").length != 0){
            		layer.confirm('确认删除信息 ？', {icon: 3}, function(index){
						...
						$.post("<%=basePath%>system_role/delete.json",{"id":id},function(data){
				    		layer.close(index);
				    		initData();
				        });
					});
